...
--
-- Host: 127.0.0.1    Database: ecommerce_dio
-- ------------------------------------------------------
...
CREATE TABLE `produto_fornecedor` (
  `idFsupplier` int NOT NULL,
  `idFproduct` int NOT NULL,
  `quantity` int NOT NULL,
  PRIMARY KEY (`idFsupplier`,`idFproduct`),
  KEY `fk_supplier_product` (`idFproduct`)
...
-- Dump completed on 2025-12-17  1:35:14
